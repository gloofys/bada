<template>
  <div class="container">
    ...
    <h4>Entrances</h4>
    <p>There are two main entrances, one on each of the first two floors, offering convenient access and added
      flexibility for different living arrangements.</p>

    <h4>Kitchens and Bathrooms</h4>
    <p>Each of the first two floors is equipped with a modern kitchen and a full bathroom with a shower. The kitchen on
      the upper floor also includes a dining area, perfect for family meals and gatherings.</p>
  </div>
</template>
